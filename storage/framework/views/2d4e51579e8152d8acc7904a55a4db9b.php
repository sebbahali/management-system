...
<a href="<?php echo e(route('ShiftsTypes.index')); ?>">   الادارات</a>
<?php $__env->stopSection(); ?>
   ...
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  بيانات  إدارات الموظفين 
            <a href="<?php echo e(route('departements.create')); ?>" class="btn btn-sm btn-warning">اضافة جديد</a>
         </h3>
      </div>
         ...
         <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <a  href="<?php echo e(route('departements.edit',$info->id)); ?>" class="btn btn-success btn-sm">تعديل</a>
                     <a  href="<?php echo e(route('departements.destroy',$info->id)); ?>" class="btn are_you_shur  btn-danger btn-sm">حذف</a>
                  </td>
               </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Timgad informatique\Desktop\atef soft\Laravel10_HRMS-86_last_branch_public\resources\views/admin/Departements/index.blade.php ENDPATH**/ ?>