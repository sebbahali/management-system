...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12">
               <div class="form-group">
                  ...
                  <input type="text" name="phones" id="phones" class="form-control" value="<?php echo e(old('phones')); ?>" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Timgad informatique\Desktop\atef soft\Laravel10_HRMS-86_last_branch_public\resources\views/admin/Branches/create.blade.php ENDPATH**/ ?>