...
<a href="<?php echo e(route('Religions.index')); ?>">   انواع  الديانات</a>
<?php $__env->stopSection(); ?>
   ...
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  بيانات  أنواع  ديانات الموظفين 
            <a href="<?php echo e(route('Religions.create')); ?>" class="btn btn-sm btn-warning">اضافة جديد</a>
         </h3>
      </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Timgad informatique\Desktop\atef soft\Laravel10_HRMS-86_last_branch_public\resources\views/admin/Religions/index.blade.php ENDPATH**/ ?>