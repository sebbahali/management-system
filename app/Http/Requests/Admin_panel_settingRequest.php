...
class Admin_panel_settingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phones' => 'required|string|max:250',
            'address' => 'required|string',
            'after_miniute_calculate_delay' => 'required|numeric|min:0',
            'after_miniute_calculate_early_departure' => 'required|numeric|min:0',
            'after_miniute_quarterday' => 'required|numeric|min:0',
            'after_time_half_daycut' => 'required|numeric|min:0',
            'after_time_allday_daycut' => 'required|numeric|min:0',
            'monthly_vacation_balance' => 'required|numeric|min:0',
            'after_days_begin_vacation' => 'required|numeric|min:0',
            'first_balance_begin_vacation' => 'required|numeric|min:0',
            'sanctions_value_first_abcence' => 'required|numeric|min:0',
            'sanctions_value_second_abcence' => 'required|numeric|min:0',
            'sanctions_value_thaird_abcence' => 'required|numeric|min:0',
            'sanctions_value_forth_abcence' => 'required|numeric|min:0',
        ];
    }
