...
function get_cols_where_p($model = null, $columns_names = [], $where = [], $order_field = 'id', $order_type = 'DESC', $pagination_counter = 13)
{
...
function get_cols_where2_p($model = null, $columns_names = [], $where = [], $where2field = null, $where2operator = null, $where2value = null, $order_field = 'id', $order_type = 'DESC', $pagination_counter = 13)
{
...
/*get some cols  table */
function get_cols_where($model = null, $columns_names = [], $where = [], $order_field = 'id', $order_type = 'DESC')
{
...
/*get some cols  table */
function get_cols_where_limit($model = null, $columns_names = [], $where = [], $order_field = 'id', $order_type = 'DESC', $limit = 1)
{
...
function get_cols_where_order2($model = null, $columns_names = [], $where = [], $order_field = 'id', $order_type = 'DESC', $order_field2 = 'id', $order_type2 = 'DESC')
{
...
/*get some cols  table */
function get_cols($model = null, $columns_names = [], $order_field = 'id', $order_type = 'DESC')
{
...
function get_cols_where_row($model = null, $columns_names = [], $where = [])
{
...
function get_cols_where2_row($model = null, $columns_names = [], $where = [], $where2 = '')
{
...
function get_cols_where_row_orderby($model, $columns_names = [], $where = [], $order_field = 'id', $order_type = 'DESC')
{
...
function insert($model = null, $arrayToInsert = [], $returnData = false)
{
    ...
    if ($returnData == true) {
        $data = get_cols_where_row($model, ['*'], $arrayToInsert);
...
function get_field_value($model = null, $field_name = null, $where = [])
{
    $data = $model::where($where)->value($field_name);

    return $data;
}
function update($model = null, $data_to_update = [], $where = [])
{
    $flag = $model::where($where)->update($data_to_update);

    return $flag;
}
function destroy($model = null, $where = [])
{
    $flag = $model::where($where)->delete();

    return $flag;
}
function get_sum_where($model = null, $field_name = null, $where = [])
{
